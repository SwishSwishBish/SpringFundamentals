...
import com.sena.dto.ProductV1;
import com.sena.dto.ProductV2;
...
public class ProductController {
    ...
    public ResponseEntity<ProductV1> pathVersioningProductV1() {
        return ResponseEntity.of(Optional.of(new ProductV1("Product")));
    }

    // http://localhost:8080/api/v2/product
    @GetMapping(value = "/v2/product")
    public ResponseEntity<ProductV2> pathVersioningProductV2() {
        return ResponseEntity.of(Optional.of(new ProductV2("Product", BigDecimal.TEN)));
    }
